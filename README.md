...
### [083. 스트림 API 체인에서 부수 효과를 일으킴](docs/08/083.md)
...
### [089. 문자열을 불리언으로 잘못 변환](docs/08/089.md)
### [090. 잘못된 날짜 포맷](docs/08/090.md)
### [091. 약한 참조, 부드러운 참조의 우발적 무효화](docs/08/091.md)
### [092. 세상이 안정적이라는 가정](docs/08/092.md)
### [093. 동시 업데이트 데이터 구조에 대한 비원자적 접근](docs/08/093.md)

# 9. 유닛 테스트
### [094. assert 문의 부수효과](docs/09/094.md)
### [095. 잘못된 assertion 메서드 호출](docs/09/095.md)
### [096. 잘못된 예외 테스트](docs/09/096.md)
### [097. 테스트 메서드 조기 종료](docs/09/097.md)
### [098. 유닛 테스트에서 AssertionError 무시하기](docs/09/098.md)
### [099. assertNotEquals()로 동등성 비교하기](docs/09/099.md)
### [100. 양식이 잘못된 테스트 메서드](docs/09/100.md)
